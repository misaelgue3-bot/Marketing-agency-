...
async function chatReply(history, { customerName = '', prices = {} } = {}) {
  ...
  const { text } = await llm.chat({
    system:
      ...
      `Our plans: Inicial/Starter $${prices.price1 || 199}/month, Crecimiento/Growth $${prices.price2 || 399}/month, Pro $${prices.price3 || 699}/month — all month-to-month, no long contracts. ` +
    ...
    ads: {
      ...
      items: {
        ...
        properties: {
          ...
          imagePrompt: { type: 'string', description: 'The English visual prompt for this ad\'s image, or empty string' },
        },
      },
    },
    weeklyCalendar: {
