...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .signs { display:grid; grid-template-columns:1fr 1fr; gap:40px; margin-top:44px; }
  .sign { border-top:1px solid var(--ink); padding-top:8px; font-size:13px; color:var(--muted); }
  ...
  @media (max-width:640px){ .sheet { padding:26px 20px; } .facts { grid-template-columns:1fr 1fr; } .signs { grid-template-columns:1fr; gap:26px; } }
</style></head>
<body>
  ...
  <div class="sheet">
    ...
    <div class="signs">
      <div class="sign">Firma del cliente — ${esc(client.name || '')}</div>
      <div class="sign">Por Your LocalLift</div>
    </div>
