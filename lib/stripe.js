...
/** Creates a hosted Checkout Session for a one-time payment (e.g. a website project). */
async function createOneTimeCheckout({ productName, amountUsd, customerEmail, metadata = {}, successUrl, cancelUrl }) {
  return api('checkout/sessions', {
    mode: 'payment',
    success_url: successUrl,
    cancel_url: cancelUrl,
...
module.exports = { available, webhookReady, createSubscriptionCheckout, createOneTimeCheckout, verifyWebhook };
